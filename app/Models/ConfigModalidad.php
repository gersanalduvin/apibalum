...
class ConfigModalidad extends Model
{
    use HasFactory, SoftDeletes, Auditable;

    protected $table = 'config_modalidad';
    ...
    // Relación con grupos removida: el módulo de grupos ya no usa modalidad
