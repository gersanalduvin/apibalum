...
class ConfigFormaPago extends Model
{
    use HasFactory, SoftDeletes, Auditable;

    protected $table = 'config_formas_pago';
    ...
    protected $auditableFields = ['nombre','abreviatura','activo','es_efectivo','moneda'];
