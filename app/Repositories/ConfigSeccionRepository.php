...
class ConfigSeccionRepository
{
    public function __construct(private ConfigSeccion $model) {}
    ...
    public function create(array $data): ConfigSeccion
    {
        return $this->model->create($data);
    }

    public function find(int $id): ?ConfigSeccion
    {
        return $this->model->with(['createdBy', 'updatedBy', 'deletedBy', 'grupos'])
            ->find($id);
    }

    public function findByUuid(string $uuid): ?ConfigSeccion
    {
        return $this->model->with(['createdBy', 'updatedBy', 'deletedBy', 'grupos'])
            ->where('uuid', $uuid)
            ->first();
    ...
    public function findByName(string $nombre): ?ConfigSeccion
    {
        return $this->model->where('nombre', $nombre)->first();
    }

    public function getByOrden(int $orden): ?ConfigSeccion
    {
